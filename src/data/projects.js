const projects = [
...

  {
    ...
    status: 'IN PROGRESS',
    description:
      'A production-style full-stack e-commerce platform featuring product discovery, authentication, cart management, checkout, order tracking, image uploads, and an admin dashboard for managing products, inventory, and orders.',
    technologies: [
      'React',
      'Vite',
      'Tailwind CSS',
...

  {
    ...
    status: 'PLANNED',
    description:
      'A collaborative workspace where teams can manage projects, tasks and discussions while receiving real-time updates across shared workspaces.',
    technologies: [
      'React',
      'Node.js',
      'Express',
...

  {
    ...
    status: 'PLANNED',
    description:
      'A real-time messaging application supporting private and group conversations, online presence, typing indicators, message history and instant message delivery.',
    technologies: [
      'React',
      'Node.js',
      'Express',
